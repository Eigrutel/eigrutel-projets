...
La version reste **0.14.2** pour cette étape. Une version stable 1.0.0 pourra être préparée après validation, avec mise à jour cohérente du HTML, du README, de la notice et de l’historique. Le fichier `RELEASE_NOTES.md` contient un texte prêt pour une éventuelle préversion 0.14.2.
